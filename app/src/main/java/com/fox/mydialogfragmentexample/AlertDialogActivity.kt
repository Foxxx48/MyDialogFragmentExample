...
import com.fox.mydialogfragmentexample.databinding.ActivityAlertDialogBinding
import java.util.*

class AlertDialogActivity : AppCompatActivity() {
    private var _binding: ActivityAlertDialogBinding? = null
...
//        val layoutParams1 = btnNegative.layoutParams as LinearLayout.LayoutParams
        ...
        val layoutParams1 = btnNegative.layoutParams as LinearLayout.LayoutParams
        layoutParams1.weight = 5f
        btnNegative.layoutParams = layoutParams1
    ...
    fun withEditText(view: View) {
        ...
        builder.setPositiveButton("OK") { dialogInterface, i -> Toast.makeText(applicationContext, "EditText is ${editText.text}", Toast.LENGTH_SHORT).show() }
        builder.show()
    }
}